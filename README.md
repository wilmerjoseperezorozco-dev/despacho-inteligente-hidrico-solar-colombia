...
| Fase 2 — Modelo de predicción de caudal | Entrenamiento y validación del modelo con datos históricos | 🔄 En progreso — GUATAPE: NSE 0,124 tras quitar predictor con importancia negativa confirmada (Riotex); NARE con transformación log1p: NSE 0,332, se acerca a la persistencia (0,36) sin superarla; sobreajuste identificado como limitación de datos, no de hiperparámetros; extensión de CHIRPS diario 2000-2023 en curso |
